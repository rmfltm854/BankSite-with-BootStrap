...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
  <header class="mb-auto">
    <div>
      <h3 class="float-md-start mb-0">MS은행</h3>
      <nav class="nav nav-masthead justify-content-center float-md-end">
        <a class="nav-link active" aria-current="page" href="Main.jsp">Home</a>
        <a class="nav-link" href="Captain.jsp">직원로그인</a>
      </nav>
    </div>
  </header>
  ...
  <main class="px-3">
    <h1>MS은행</h1>
    <p class="lead">저희 은행을 방문해주셔서 감사합니다</p>
    <p class="lead">
      <a href="Customer/CustomerLogin.jsp" class="btn btn-lg btn-secondary fw-bold border-white bg-black">이용하기</a>
    </p>
  </main>
